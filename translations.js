...
const I18N = (() => {
  ...
  const dicionario = {
    pt: {
      ...
      "resources.video": "Aula",
      "resources.music": "Música",
      "resources.pdf": "Livro",
      "resources.deepen": "Ir Além",
      "resources.app": "App",
      "resources.deepenAria": "Abrir vídeos de aprofundamento: {title}",
      "resources.appAria": "Abrir aplicativo de apoio: {title}",
    ...
    en: {
      ...
      "resources.pdf": "PDF",
      "resources.deepen": "Explore More",
      "resources.app": "App",
      "resources.deepenAria": "Open additional videos: {title}",
      "resources.appAria": "Open support app: {title}",
    ...
    es: {
      ...
      "resources.pdf": "PDF",
      "resources.deepen": "Profundizar",
      "resources.app": "Aplicación",
      "resources.deepenAria": "Abrir videos de profundización: {title}",
      "resources.appAria": "Abrir aplicación de apoyo: {title}",
